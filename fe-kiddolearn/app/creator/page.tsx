    ...
    <div className="min-h-screen bg-[#FFF9F0] font-sans text-[#4A4A4A]">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          ...
          {/* Books Card */}
          <div 
            onClick={() => router.push('/creator/books')}
            className="bg-white rounded-[2rem] p-6 border-4 border-[#FFE0B2] shadow-xl relative overflow-hidden hover:-translate-y-1 transition-all duration-300 cursor-pointer group animate-slide-up" 
          ...
          >
            ...
            <div className="relative z-10">
              <div className="text-4xl mb-3 drop-shadow-sm group-hover:scale-110 transition-transform">📚</div>
              <div className="text-sm text-[#8B7355] font-bold uppercase tracking-wide">Kelola Buku</div>
              <p className="text-xs text-[#8B7355]/70 font-bold mt-1">Upload & Manage</p>
            </div>
          </div>
        </div>
